...
ANSIBLE_VAULT_PASSWORD_FILE=~/.pws/vault
...
alias hostmux='/home/martin/hostmux/hostmux'
...
mp3p () {
	youtube-dl --ignore-errors -f bestaudio --extract-audio --audio-format mp3 --audio-quality 0 -o '~/Musik/youtube/%(playlist)s/%(playlist_index)s - %(title)s.%(ext)s' "$1"
}
